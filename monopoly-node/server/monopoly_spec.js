...
describe("Comprobando metodo FactoryJuego...",function(){
	beforeEach(function(){
		this.juego = new modelo.FactoryJuego();
...
describe("Comprobando funcionalidad del tablero...",function(){
	beforeEach(function(){
		this.tablero = new modelo.Tablero(40);
		this.coleccionFichas=[new modelo.Ficha("Perro"),new modelo.Ficha("Sombrero"),new modelo.Ficha("Coche")];
		this.juego = new modelo.Partida(this.tablero, this.coleccionFichas,3);
		this.Jug1=new modelo.Jugador("Jug1",this.juego);
		this.Jug1.asignarFicha();
		this.Jug2=new modelo.Jugador("Jug2",this.juego);
		this.Jug2.asignarFicha();
		this.Jug3=new modelo.Jugador("Jug3",this.juego);
...
describe("Dado",function(){
	...
	var dado;
	beforeEach(function(){
		tablero=new modelo.Tablero(40);
		dado=new modelo.Dado();
	});
