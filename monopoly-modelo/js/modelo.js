...
function Estacion(nombre,precio){
	...
	this.precio=precio;
		...
		if(this.comprador == undefined){
			var entrada=prompt('¿Quieres comprar esta estacion? [s/n]','');
				if(entrada=="s" && ficha.saldo>this.precio){
...
function Calle(nombre,precio,color){
	...
	this.comprador=undefined;
		...
		console.log(nombre);
		if(this.comprador == undefined){
			var entrada=prompt('¿Quieres comprar esta calle? [s/n]','');
				if(entrada=="s" && ficha.saldo>precio){
						this.comprador=ficha;
						ficha.asignarCompra(ficha,this);
						ficha.saldo=ficha.saldo-precio;
